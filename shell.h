...
void _find_command(info_t *);
void _fork_command(info_t *);

/* toem_parser.c */
int command(info_t *, char *);
char *is_dup_chars(char *, int, int);
...
/* toem_atoi.c */
int mode_interactive(info_t *);
int is_a_delim(char, char *);
int _is_alpha(int);
int _a_toi(char *);
...
/* toem_builtin.c */
int is_myexit(info_t *);
int is_mycd(info_t *);
int is_myhelp(info_t *);

/* toem_builtin1.c */
int is_myhistory(info_t *);
int is_myalias(info_t *);

/*toem_getline.c */
ssize_t _get_input(info_t *);
int is_getline(info_t *, char **, size_t *);
...
/* toem_environ.c */
char *is_getenv(info_t *, const char *);
int is_myenv(info_t *);
int is_mysetenv(info_t *);
int is_myunsetenv(info_t *);
int _populate_env_list(info_t *);

/* toem_getenv.c */
char **_get_environ(info_t *);
int is_unsetenv(info_t *, char *);
int is_setenv(info_t *, char *, char *);
